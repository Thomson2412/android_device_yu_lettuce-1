...
public class KeyHandler implements DeviceKeyHandler {
    ...
    public KeyHandler(Context context) {
        ...
        mProximityTimeOut = 250;//resources.getInteger(org.cyanogenmod.platform.internal.R.integer.config_proximityCheckTimeout);
        mProximityWakeSupported = false;//resources.getBoolean(org.cyanogenmod.platform.internal.R.bool.config_proximityCheckOnWake);
    ...
    public boolean handleKeyEvent(KeyEvent event) {
        ...
        if (!mEventHandler.hasMessages(GESTURE_REQUEST)) {
            ...
            boolean defaultProximity = false; //mContext.getResources().getBoolean(org.cyanogenmod.platform.internal.R.bool.config_proximityCheckOnWakeEnabledByDefault);
